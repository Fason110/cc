...
var maxCount = 30;//isNotEmptyString(MAX_REQUEST_PER_15_MINUTES) && !isNaN(Number(MAX_REQUEST_PER_15_MINUTES)) ? parseInt(MAX_REQUEST_PER_15_MINUTES) : 25;
var limiter = (0, import_express_rate_limit.rateLimit)({
  windowMs: 15 * 60 * 1e3,
...
// 允许访问的IP地址列表
var allowed_ips = ['183.63.121.10', '202.60.227.25', '172.247.129.5','58.34.141.218','154.21.85.3'];
